...
namespace MerchandiseService.Domain.Tests
{
    public class EmployeeEntityTests
    {
        ...
        public void ConstructorDontAcceptNullArguments()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new Employee(new EmployeeId(1), null, ClothingSize.XL));
        ...
        {
            var employee = new Employee(new EmployeeId(1), new Email("some@good.email"), ClothingSize.XL);
